    ...
    stages {
      ...
      stage('Docker Push')
      {
        steps {
          ...
          post {
                 always {
           	     jiraSendDeploymentInfo environmentId: 'dev', environmentName: 'dev', environmentType: 'development', issueKeys: ['TEST-3']
                 }
             }
      }
      stage('JIRA') 
      {
        steps {
		 script {
          ...
          testIssue = [fields: [ project: [key: 'TEST'],summary: 'New JIRA Created from Jenkins.',description: 'New JIRA Created from Jenkins.',issuetype: [id: '10001']]]
